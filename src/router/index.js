  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        path: '/cource/create',
        name: 'course-create',
        component: () => import(/* webpackChunkName: 'course-create' */'@/views/cource/create.vue'),
        meta: { requiresAuth: true }
      },
      {
        path: '/cource/:courseId/edit',
        name: 'course-edit',
        component: () => import(/* webpackChunkName: 'course-edit' */'@/views/cource/edit.vue'),
        meta: { requiresAuth: true },
        props: true
      },
      {
